...
(() => {
  ...
  if (header && toggle && nav) {
    const closeNav = () => {
      ...
      toggle.setAttribute("aria-label", (localStorage.getItem("tbb-language")==="de" ? "Navigation öffnen" : "Open navigation"));
    };
    ...
    toggle.addEventListener("click", () => {
      ...
      toggle.setAttribute("aria-label", open ? (localStorage.getItem("tbb-language")==="de" ? "Navigation schließen" : "Close navigation") : (localStorage.getItem("tbb-language")==="de" ? "Navigation öffnen" : "Open navigation"));
    });
